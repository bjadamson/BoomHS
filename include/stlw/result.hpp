...
// DO_MONAD
#define DO_MONAD_CONCAT(VAR_DECL, V, expr) DO_GENERAL_EVAL(VAR_DECL, _DO_MONAD_TEMPORARY_##V, expr)
...
#define DO_MONAD_OR_ELSE_EVAL(VAR_DECL, V, expr, fn) DO_GENERAL_OR_ELSE_EVAL(VAR_DECL, V, expr, fn)
#define DO_MONAD_OR_ELSE_CONCAT(VAR_DECL, to_concat, expr, fn)                                     \
  DO_MONAD_OR_ELSE_EVAL(VAR_DECL, _DO_MONAD_OR_ELSE_TEMPORARY_##to_concat, expr, fn)
#define DO_MONAD_OR_ELSE_EXPAND(VAR_DECL, to_concat, expr, fn)                                     \
  DO_MONAD_OR_ELSE_CONCAT(VAR_DECL, to_concat, expr, fn)
#define DO_MONAD_OR_ELSE_RETURN(VAR_DECL, expr, fn)                                                \
  DO_MONAD_OR_ELSE_EXPAND(VAR_DECL, __COUNTER__, expr, fn)
