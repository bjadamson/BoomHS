    ...
    , sp_(&sp)
{
  ...
  sp_->while_bound(logger, [&]() { shader::set_uniform(logger, *sp_, "u_sampler", 0); });
}
...

{
  ...
  sp_->while_bound(logger, [&]() {
    ...
    shader::set_uniform(logger, *sp_, "u_dirlight.screenspace_pos", directional_light.screenspace_pos);
